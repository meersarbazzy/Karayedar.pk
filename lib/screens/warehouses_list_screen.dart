...
class WarehousesListScreenDetails extends StatefulWidget {
  final Map<String, dynamic> data;

  WarehousesListScreenDetails({Key? key, required this.data}) : super(key: key);

  @override
  State<WarehousesListScreenDetails> createState() => _WarehousesListScreenDetailsState();
}

class _WarehousesListScreenDetailsState extends State<WarehousesListScreenDetails> {
