...
class OthersPropertyDetailsScreen extends StatefulWidget {
  final Map<String, dynamic> data;

  OthersPropertyDetailsScreen({Key? key, required this.data}) : super(key: key);

  @override
  State<OthersPropertyDetailsScreen> createState() => _OthersPropertyDetailsScreenState();
}

class _OthersPropertyDetailsScreenState extends State<OthersPropertyDetailsScreen> {
