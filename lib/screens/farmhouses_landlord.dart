...
class FarmhousesPage extends StatefulWidget {
  @override
  _FarmhousesPageState createState() => _FarmhousesPageState();
}

class _FarmhousesPageState extends State<FarmhousesPage> {
  ...
  TextEditingController _perDayRentController = TextEditingController(); // Changed from monthly rent
  ...
  void _postAd() async {
    ...
    final farmhouseData = {
      ...
      'perDayRent': _perDayRentController.text, // Changed from monthly rent
    ...
    final farmhouseId = await FirebaseFirestore.instance
    ...
    for (int i = 0; i < _selectedImages.length; i++) {
      final storageRef =
      FirebaseStorage.instance.ref('farmhouses/$farmhouseId/image$i');
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: TextField(
                      controller: _perDayRentController,
                      decoration: _decoratedTextField('Per Day Rent', iconData: Icons.attach_money, prefixText: '$_selectedCurrency '),
                    ),
                  ),
                  SizedBox(width: 10),
                  DropdownButtonHideUnderline(
