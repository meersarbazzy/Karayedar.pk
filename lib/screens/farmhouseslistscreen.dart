...
class FarmhousesListScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Farmhouses"),
      ...
      body: Padding(
        ...
        child: StreamBuilder(
          stream:
              FirebaseFirestore.instance.collection('farmhouses').snapshots(),
          builder:
                ...
                return ImageCardButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => FarmhousesListScreenDetails(
                          data:
                              data, // Pass the entire data map, including the document ID
                        ),
                      ),
                    );
                  },
