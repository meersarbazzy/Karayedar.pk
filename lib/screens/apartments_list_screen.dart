...
class ApartmentsListScreenDetails extends StatefulWidget {
  final Map<String, dynamic> data;

  ApartmentsListScreenDetails({Key? key, required this.data}) : super(key: key);

  @override
  State<ApartmentsListScreenDetails> createState() => _ApartmentsListScreenDetailsState();
}

class _ApartmentsListScreenDetailsState extends State<ApartmentsListScreenDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    print('Data received in ApartmentsListScreenDetails: ${widget.data}');
