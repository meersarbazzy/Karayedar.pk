...
class OthersListScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('otherProperties').snapshots(),
          builder:
                ...
                return ImageCardButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => OthersPropertyDetailsScreen(
                          data: data,
                        ),
                      ),
                    );
