...
class FarmhousesListScreenDetails extends StatefulWidget {
  final Map<String, dynamic> data;

  FarmhousesListScreenDetails({Key? key, required this.data}) : super(key: key);

  @override
  State<FarmhousesListScreenDetails> createState() => _FarmhousesListScreenDetailsState();
}

class _FarmhousesListScreenDetailsState extends State<FarmhousesListScreenDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    print('Data received in FarmhousesListScreenDetails: ${widget.data}');
        ...
        children: [
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Area Size: ${widget.data
                        ['areaSize'] ?? 'N/A'} ${widget.data
                        ['areaType'] ?? ''}',
                        style: TextStyle(fontSize: 16),
                      ),
                    ),
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Monthly Rent: ${widget.data
                        ['currency'] ?? ''} ${widget.data
                        ['monthlyRent'] ?? 'N/A'}',
                        style: TextStyle(fontSize: 16),
                      ),
                    ),
          ...
          StreamBuilder<double>(
            stream: getAverageRating(
                widget.data
                ['id']), // assuming 'id' holds the propertyId
          ...
          Container(
            ...
            child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  .collection('reviews')
                  .where('propertyId', isEqualTo: widget.data
              ['id'])
                  .snapshots(),
              builder: (context, snapshot) {
